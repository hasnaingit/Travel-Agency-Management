                                        ...
                                        <table border="1" cellspacing="15">
                                            ...
                                            <tbody>
                                                ...
                                                <tr ng-repeat="x in flo">
                                                    ...
                                                    <td><a href="editingfeedback?feedbackid={{x.feedbackid}}"><button id="editbuttons" type="submit" class="btn">Edit</button></a> <a href="removefeedback/{{x.feedbackid}}"><button  id="removebuttons" type="button" class="btn btn-danger">Remove</button></a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
