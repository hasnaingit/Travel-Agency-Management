...
th { background-color: #4CAF50; color: white;}                
		...
		<script>
            var packcat = ${packcategorymodelobject};
            console.log(packcat);
            angular.module('myapp', []).controller('packcatController',
                    function ($scope) {
                        $scope.Packcategory = packcat;
                    });
        </script> 
          ...
          <aside class="main-sidebar">
            ...
            <!-- Main content -->
                <section class="content">                   
                    <div class="formheading">    <h1 c > Package Category Info</h1> </div>
                    <div class="formbg">                    
                    <c:if test="${check}">
        <form:form name="addCategoryObject" modelAttribute="PackCategoryObject1" action="addingpackcategory" method="post">

            <label  class="l" for="catid">Package category id </label>
            <form:input class="inp" type="text" path="packcatid" required="true" id="packcatid"></form:input> 


                <label class="l" for="catname">Package Title</label>
            <form:input class="inp" type="text" path="packtitle" required="true" id="packtitle"></form:input> <br></br>


                <label class="l" for="catname">Package details</label>
            <form:input  class="inp" type="text" path="packdetails" required="true" id="packdetails"></form:input> 
               
            
           

            <form:button  class ="sub" id="editbuttons" type="submit" name="Add" >Add Customer</form:button>
            <form:button class ="sub"  id="removebuttons" type="reset" >Reset Details</form:button> 
            <a href="showpackcategorypage" class="sub">cancel</a>
        </form:form>
</c:if>
 <c:if test="${!check}">
    ...
    <form:form name="addCategoryObject" modelAttribute="PackCategoryObject1" action="addingpackcategory" method="post">
            ...
            <form:button class ="sub"  id="editbuttons" type="submit" name="Edit" >Edit Customer</form:button>
            <form:button class ="sub"  id="removebuttons" type="reset" >Reset Details</form:button>
               <a href="showpackcategorypage" class="sub">cancel</a>
        </form:form>
 </c:if>
        ...
        <div ng-controller="packcatController">
            ...
            <table border="1" cellspacing="15">
                <thead>
                    <tr>
                        ...
                        <th>package category Details</th>
                     
                    </tr>
                </thead>
                <tbody>
                    <tr ng-repeat="pc in Packcategory">
                                               
                        <td>{{pc.packcatid}}</td>
                        <td>{{pc.packtitle}}</td>
                        <td>{{pc.packdetails}}</td>
              
                        
                        
                        <td><a href="editpackcategorybutton?packcatid={{pc.packcatid}}"><button id="editbuttons" type="submit" class="btn">Edit</button></a> <a href="removepackcategory/{{pc.packcatid}}"><button  id="removebuttons" type="button" class="btn btn-danger">Remove</button></a>
                        </td>
                    </tr>
                </tbody>
            </table>
