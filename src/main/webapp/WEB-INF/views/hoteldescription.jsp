    ...
    text-align: left;
        ...
        <script>
            ...
            angular.module('myapp', []).controller(
                    'HotelController', function ($scope) {
                        $scope.pdo = hoteldata;
                    });
        </script>
  </head>
	...
	<div class="container">
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <div class="card mt-4" ng-app="myapp" ng-controller="HotelController">
                        <img class="card-img-top img-fluid" src="resources/image/{{pdo.hotelid}}.jpg" width="600" height="100" alt="">
                        <div class="card-body">
                            <h1 class="card-title"> Hotel id : {{pdo.hotelid}}</h1>
                            <h2 class="card-title">Hotel Name:   {{pdo.hotelname}} </h2>
                            <h2 class="card-title">  Room Number : {{pdo.roomno}} </h2>
                            <h2 class="card-title">  Hotel Location: {{pdo.location}} </h2>
                            <h3> Price per Night (for single person ) Tk.{{pdo.price}}</h3>
                           
                                             
                        </div>
                        <div class="btn-group cart">
                            <c:if test="${sessionScope.UserLoggedIn !=null}">
                                <h1> <a href="showhotelbookingpage?getPackId={{pdo.hotelid}}" 
                                        class="" id="cartbutton" style="padding: 10px; border: 3px solid red;"> Book Hotel </a></h1> 
                                        <h2><a href="hoteldescription" class="" id="cartbutton" style="padding: 10px;"> View More Hotel </a></h2>
                            </c:if>
                            <c:if test="${sessionScope.UserLoggedIn == null}">
                                <a href="perlogcheck?getPackId={{pdo.hotelid}}"
                                   class="btn btn-primary" id="loginproductsbutton"
                                   >Book Hotel</a>
                                <a href="hoteldescription" class="btn btn-primary" id="viewproductsbutton">  View More Hotel </a>
                            </c:if>
                        </div>
                    </div>
                </div>
