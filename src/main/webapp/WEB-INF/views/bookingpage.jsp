...
<section id="main-content"> <br>
                ...
                <div id="leftdiv" class="col-sm-6">
                    ...
                    <div class="input-group">
                        <form:input type="hidden" class="form-control" id="" name=""
                                    aria-describedby="basic-addon1" path="packbookingid"></form:input>
                        </div>
                    <div> <h3> User Email</h3></div>
                     ...
                     <div class="input-group">
                      ...
                      <div class="input-group">
                        ...
                        <label  class="form-control"
                                    id="" name=""
                                    aria-describedby="basic-addon1" >Packid : ${sessionScope.packid} </label>
                        </div>
 ...
 <div> <h3> Your Package Id</h3></div>
                        <div class="input-group">
                            <span class="input-group-addon" id="basic-addon1"> <i
                                    class="fa fa-address-card" aria-hidden="true"></i>
                            </span>
                        <form:input type="text" class="form-control"
                                    placeholder="packid" id="" name="" value="${sessionScope.packid}"
                                    aria-describedby="basic-addon1" path="packid"></form:input>
                        </div>
 <div> <h3>Date</h3></div>
                        <div class="input-group">
                            <span class="input-group-addon" id="basic-addon1"> <i
                        ...
                        <form:input type="text" class="form-control"
                                    placeholder="bookingdate" id="" name=""
                                    aria-describedby="basic-addon1" path="bookingdate"></form:input>
                        </div>
  <div> <h3> your any request</h3></div>

                        <div class="input-group">
                            <span class="input-group-addon" id="basic-addon1">
                                <div class="glyphicon glyphicon-inbox"></div>
                            </span>
                        <form:input type="text" class="form-control" placeholder="your request"
                                    id="" name="" aria-describedby="basic-addon1" path="bookingstatus"></form:input>
                        </div>
