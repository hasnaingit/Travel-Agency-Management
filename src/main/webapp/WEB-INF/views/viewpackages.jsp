  ...
  .topnav.responsive a {
    ...
    text-align: left;
        ...
        <script>
            ...
            angular.module('myapp', []).controller('PackageController',
                    function ($scope) {
                        $scope.productangularobject = packagelist;
                    });
        </script>
...
<div class="topnav" id="myTopnav">
 ...
 <br>
            ...
            <div class="panel scroll animated fadeInUp delay-05s" style="margin-left: 50px; width: 300px; height: 300px;"
                 ng-repeat="p in productangularobject">
                <a href="packagedescription?getId={{p.packid}}" id="producta">

                    <div class="panel-body">

                        <img id="productimage" class="img-rounded img-fluid"
                             src="resources/image/{{p.packid}}.jpg" height="200px"
                             width="200px">

                        <div class="lead" style="margin-top: 5px">{{p.location}}</div>
                        <div class="">{{p.description}}</div>
                        <hr>
                        <div id="pricediv">
                            <strong style="margin-top: 10px">Tk.{{p.totalcost}}</strong>
                        </div>
                    </div>
                </a>
            </div>
