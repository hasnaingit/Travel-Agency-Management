...
<html lang="en">
    <head>
        ...
        <script>
                    var hotelbookinglisto = ${hotelbookinglist};
                    var hotellisto = ${hotellist};
                    var customerlisto = ${customerlist};
                    angular.module('myapp', []).controller('hotelbookingController',
                            function ($scope) {
                                $scope.hblo = hotelbookinglisto;
                                $scope.hlo = hotellisto;
                                $scope.clo = customerlisto;
                                console.log($scope.hblo);
                                console.log($scope.hlo);
    ...
    <body class="hold-transition sidebar-mini"    ng-app="myapp" ng-controller="hotelbookingController">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <div class="content-wrapper">
                                ...
                                <section class="content">                   
                                    <div class="formheading">    <h1> Hotel Booking</h1> </div>

                                    <c:if test="${check}">
                                        <form:form name="addhotelbookingObject" modelAttribute="newHotelBookingObject" action="hotelbookingadd" method="post">

                                            <label  class="l" for="catid">hotelbooking id</label>
                                            <form:input class="inp" type="text" path="hotelbookingid" required="true" id="hotelbookingid"></form:input> 


   <label  class="l" for="catid">Select Hotel id</label>
                                                <select  ng-model="hotelid" ng-options="h.hotelid as h.hotelname for h in hlo" required="true" class="inp" >
                                                    <option value="" class="inp">-- Choose Hotel Id --</option>
                                                </select>

                                            <form:hidden  value="{{hotelid}}" path="hotelid"></form:hidden><br></br> 
   ...
   <label  class="l" for="catid">Select Customer id</label>
                                            ...
                                            <form:hidden  value="{{custid}}" path="custid"></form:hidden><br></br> 
                                                ...
                                                <label class="l" for="catname">-Check IN-</label>
                                            <form:input class="inp" placeholder="select check-In date" type="text" path="startdate" required="true" id="startdate"></form:input> <br></br>

                                                <label class="l" for="catname">-Check out-</label>
                                            <form:input class="inp" placeholder="select check-out date" type="text" path="enddate" required="true" id="enddate"></form:input> <br></br>





                                                <label class="l" for="catname">-adultnum, -</label>
                                            <form:input class="inp" type="text" path="adultnum" required="true" id="adultnum"></form:input> <br></br>




                                                <label class="l" for="catname">-childnum-</label>
                                            <form:input class="inp" type="text" path="childnum" required="true" id="childnum"></form:input> <br></br>




                                                <label class="l" for="catname">-total days-</label>
                                            <form:input class="inp" type="text" path="totaldays" required="true" id="totaldays"></form:input> <br></br>


                                            <c:set var="now" value="<%=new java.util.Date()%>" />

                                            <label class="l" for="catname">-bookingdate-</label>
                                            <form:input class="inp" type="text" path="bookingdate" required="true" id="bookingdate" value=" ${now}" readonly="true"></form:input> <br></br>




                                                <label class="l" for="catname">-totalcost-</label>
                                            <form:input class="inp" type="text" path="totalcost" required="true" id="totalcost"></form:input> <br></br>
                                    ...
                                    <c:if test="${!check}">
                                        ...
                                        <form:form name="addhotelbookingObject" modelAttribute="newHotelBookingObject" action="hotelbookingadd" method="post">
                                            ...
                                            <form:input class="inp" type="text" path="hotelbookingid" required="true" id="hotelbookingid"></form:input> 
                                                ...
                                                <select  ng-model="hotelid" ng-options="x.hotelid as x.hotelid for x in hlo" required="true">
                                                    <option value="" class="inp">-- Choose Hotel Id --</option>
                                                </select>
                                            <form:hidden  value="{{hotelid}}" path="hotelid"></form:hidden><br></br> 
                                                ...
                                                <select  ng-model="custid" ng-options="x.custid as x.custid for x in clo" required="true">
                                                    <option value="" class="inp">-- Choose customer code --</option>
                                                </select>
                                            <form:hidden  value="{{custid}}" path="custid"></form:hidden><br></br> 
                                                ...
                                                <label class="l" for="catname">-Check IN-</label>
                                            <form:input class="inp" type="text" path="startdate" required="true" id="startdate"></form:input> <br></br>

                                                <label class="l" for="catname">-Check out-</label>
                                            <form:input class="inp" type="text" path="enddate" required="true" id="enddate"></form:input> <br></br>
                                            ...
                                            <form:input class="inp" type="text" path="totaldays" required="true" id="totaldays"></form:input> <br></br>
                                                ...
                                                <label class="l" for="catname">-bookingdate-</label>
                                            <form:input class="inp" type="text" path="bookingdate" required="true" id="bookingdate"></form:input> <br></br>
                                    ...
                                    <div >
                                        ...
                                        <table border="1" cellspacing="15">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="x in hblo">

                                                    <td>{{x.hotelbookingid}}</td>
                                                    <td>{{x.hotelid}}</td>
                                                    <td>{{x.startdate}}</td>
                                                    <td>{{x.enddate}}</td>
                                                    <td>{{x.adultnum}}</td>
                                                    ...
                                                    <td><a href="editinghotelbooking?hotelbookingid={{x.hotelbookingid}}"><button id="editbuttons" type="submit" class="btn">Edit</button></a> <a href="removehotelbooking/{{x.hotelbookingid}}"><button  id="removebuttons" type="button" class="btn btn-danger">Remove</button></a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
