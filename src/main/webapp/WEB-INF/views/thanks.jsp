<%-- 
    Document   : thanks
    Created on : Jun 30, 2019, 11:11:30 PM
    Author     : Hasnain
--%>
...
<div class="topnav" id="myTopnav">
 ...
 <br>
	...
	<div class="container"  class="w3-container w3-lobster">
           
            
              <div class="w3-panel w3-leftbar w3-sand w3-xxlarge w3-serif">
                  <p><i> Thank You <b style="color: purple;">  Mr : ${sessionScope.UserLoggedIn} </b> for TRavelling With  Us </i> </p>
  </div>
         
        
        <h4 class="w3-xxlarge" c>   your payid is : ${sessionScope.pid}</h4>
            <h4 class="w3-xxlarge c" >  your UserName : ${sessionScope.cid}</h4>
           <h4 class="w3-xxlarge c">   your Booking id is : ${sessionScope.bid}</h4>
           <h4 class="w3-xxlarge c "> Total Price you paid is : ${sessionScope.aid} </h4>
