    ...
    text-align: left;
        ...
        <script>
            ...
            angular.module('myapp', []).controller('HotelController',
                    function ($scope) {
                        $scope.productangularobject = hotellist;
                    });
        </script>
