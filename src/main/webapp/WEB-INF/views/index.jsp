<%-- 
    Document   : index
    Created on : May 23, 2019, 11:46:52 AM
    Author     : C5
--%>
...
<script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.6.9/angular.min.js"></script>
  ...
  <body ng-app="myapp" ng-controller="searchtrainController">
    
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Dhaka Travel Agency</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="displaybus" class="nav-link">Rent-A-Car</a></li>
	          <li class="nav-item"><a href="displaypackagepage" class="nav-link">Packages</a></li>
	          <li class="nav-item"><a href="displayhotel" class="nav-link">Hotels</a></li>
	          <li class="nav-item"><a href="#tips" class="nav-link"></a></li>
    ...
    <section class="ftco-section" id="package">
    	<div class="container">
    ...
    <section class="ftco-section" id="hotel">
    	<div class="container">
				<div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
    ...
    <section class="ftco-section bg-light" id="tips">
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
    ...
    <section class="ftco-section-parallax" id="contact">
