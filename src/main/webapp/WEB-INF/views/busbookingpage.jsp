...
<body ng-app="myapp" ng-controller="BusbookingController">
...
<section id="main-content"> <br>
    ...
    <div id="mainBody" class="container" style=" background-color: lightblue;">
            <form:form action="addbusbooking" method="post"
                       modelAttribute="busbookingObject">
                <div id="leftdiv" class="col-sm-6">
                    ...
                    <div class="input-group">
                        <form:input type="hidden" class="form-control" id="" name=""
                                    aria-describedby="basic-addon1" path="busbookingid"></form:input>
                        </div>
                     ...
                     <div class="input-group">
                        ...
                        <form:input type="text" class="form-control"
                                   value="${sessionScope.busid}" id="" name=""
                                    aria-describedby="basic-addon1" path="busid"></form:input>
                        </div>
                        ...
                        <form:input type="text" class="form-control"
                                  value="${sessionScope.UserLoggedIn}" id="" name=""
                                    aria-describedby="basic-addon1" path="custid"></form:input>
                        </div>
                        ...
                        <form:input type="text" class="form-control"
                                    placeholder="select date" id="" name=""
                        ...
                        <form:input type="text" class="form-control" placeholder="your comment"
                                    id="" name="" aria-describedby="basic-addon1" path="status"></form:input>
                        </div>
